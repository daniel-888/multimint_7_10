...
describe("multimint", () => {
  it("1155", async () => {
    ...
    await (await minter.deployClones(25)).wait();
    await (await minter.fundClones(25, 6, { value: "150" })).wait();
    ...
    await (
      await minter.mintWithDeployedClones1155(25, 1, 2, data, supplydata, {
        gasLimit: 1083994,
      })
    ).wait();
